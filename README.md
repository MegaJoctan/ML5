...
<p align="center">
Python-like Machine Learning & Data Science Repository for the MQL5 Programming Language.
</p>
...
Clone or ownload the zip file from the releases section extract the folder ML5 under the Include parent folder in the [MetaTrader5's terminal data path](https://www.mql5.com/en/forum/380830).

<img width="292" height="559" alt="Screenshot 2026-09-18 133137" src="https://github.com/user-attachments/assets/4e8e68a6-4822-4f19-a0a9-4c05b472bcc7" />



# Opening an issue

Post bug reports and feature requests (only) in [GitHub issues](https://github.com/MegaJoctan/MALE5/issues).

# Support the Project

- [BuyMeCoffee](https://www.buymeacoffee.com/omegajoctan)
- [OurProducts](https://www.mql5.com/en/users/omegajoctan/seller)
- Open a Trading account to my recommended broker — [ICMarkets](https://icmarkets.com/?camp=74639)
- [HIRE ME on MQL5.com](https://www.mql5.com/en/job/new?prefered=omegajoctan)
